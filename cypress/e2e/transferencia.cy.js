describe('Transferencias', () => {
    ...
    it('Deve transferir quando informo dados e valores validos', () => {
      ...
      cy.SelecionarOpçaoNaComboBox('conta-origem' , 'João da Silva')
      ...
      cy.SelecionarOpçaoNaComboBox('conta-destino' , 'Maria Oliveira')
   ...
   it.('Deve dar erro quando tentar transferir mais que 5000,00 sem token', () => {
     /* cy.SelecionarOpçaoNaComboBox('conta-origem' , 'João da Silva')
      cy.SelecionarOpçaoNaComboBox('conta-destino' , 'Maria Oliveira')
